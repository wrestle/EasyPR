...
namespace easypr {
	...
	static const char* kDefaultSvmPath = "C:/git/EasyPR/EasyPR/resources/model/svm.xml";
	static const char* kDefaultAnnPath = "C:/git/EasyPR/EasyPR/resources/model/ann.xml";
